...
public enum ErrorCode {
    ...
    EXT_AI_008("EXT_AI_008", "AI模型API认证失败"),

    EXT_OPENAI_001("EXT_OPENAI_001", "OpenAI返回空响应"),
    EXT_OPENAI_002("EXT_OPENAI_002", "OpenAI API调用失败: "),
    EXT_OPENAI_003("EXT_OPENAI_003", "OpenAI批量API调用失败: "),
    EXT_OPENAI_004("EXT_OPENAI_004", "OpenAI生成聊天完成时发生未知错误"),
    EXT_OPENAI_005("EXT_OPENAI_005", "OpenAI流式响应处理失败"),
    EXT_OPENAI_006("EXT_OPENAI_006", "OpenAI启动流式生成失败"),

    EXT_ANTHROPIC_001("EXT_ANTHROPIC_001", "Anthropic返回空响应"),
    EXT_ANTHROPIC_002("EXT_ANTHROPIC_002", "Anthropic API调用失败: "),
    EXT_ANTHROPIC_003("EXT_ANTHROPIC_003", "Anthropic生成聊天完成时发生错误"),
    EXT_ANTHROPIC_004("EXT_ANTHROPIC_004", "Anthropic流式响应处理错误"),
    EXT_ANTHROPIC_005("EXT_ANTHROPIC_005", "Anthropic流式响应处理失败"),
    EXT_ANTHROPIC_006("EXT_ANTHROPIC_006", "Anthropic流式生成异常"),

    EXT_QWEN_001("EXT_QWEN_001", "不支持的通义千问模型: "),
    EXT_QWEN_002("EXT_QWEN_002", "通义千问返回空响应"),
    EXT_QWEN_003("EXT_QWEN_003", "通义千问服务调用失败"),
    EXT_QWEN_004("EXT_QWEN_004", "通义千问批量API调用失败: "),
    EXT_QWEN_005("EXT_QWEN_005", "通义千问流式响应处理错误"),
    EXT_QWEN_006("EXT_QWEN_006", "通义千问流式响应处理失败"),
    EXT_QWEN_007("EXT_QWEN_007", "通义千问流式生成异常"),
    EXT_QWEN_008("EXT_QWEN_008", "通义千问API认证失败"),
    EXT_QWEN_009("EXT_QWEN_009", "通义千问API调用频率限制"),
    EXT_QWEN_010("EXT_QWEN_010", "通义千问API请求超时"),
    ...
    EXT_LLM_005("EXT_LLM_005", "所有首选模型都不可用: "),
    EXT_LLM_006("EXT_LLM_006", "没有健康的服务提供商"),
    EXT_LLM_007("EXT_LLM_007", "未找到服务提供商: "),
    ...
    EXT_EMB_002("EXT_EMB_002", "文本token数超出限制"),
    EXT_EMB_003("EXT_EMB_003", "批量大小超出限制"),
    EXT_EMB_004("EXT_EMB_004", "向量维度不匹配"),
    EXT_EMB_005("EXT_EMB_005", "嵌入缓存失败"),
    EXT_EMB_006("EXT_EMB_006", "向量标准化失败"),
    EXT_EMB_007("EXT_EMB_007", "嵌入响应为空"),
    EXT_EMB_008("EXT_EMB_008", "批量嵌入响应为空"),
    EXT_EMB_009("EXT_EMB_009", "批量处理被中断"),

    EXT_EMB_010("EXT_EMB_010", "OpenAI嵌入服务调用失败: "),
    EXT_EMB_011("EXT_EMB_011", "通义千问嵌入服务失败: "),
    EXT_EMB_012("EXT_EMB_012", "Anthropic目前不提供向量嵌入服务，请使用OpenAI或通义千问的嵌入服务"),
