...
public class McpSecurityManager {
    ...
    private final McpProperties.SecurityConfig securityConfig;
    private final Map<String, RateLimitInfo> rateLimitCache;

    public McpSecurityManager(McpProperties mcpProperties) {
        this.securityConfig = mcpProperties.getSecurity();
