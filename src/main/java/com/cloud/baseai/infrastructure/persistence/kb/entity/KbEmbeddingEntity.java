...
import com.cloud.baseai.infrastructure.persistence.kb.mapper.VectorType;
...
public class KbEmbeddingEntity {
     ...
     * 从领域对象创建JPA实体
     */
    public static KbEmbeddingEntity fromDomain(Embedding domain) {
