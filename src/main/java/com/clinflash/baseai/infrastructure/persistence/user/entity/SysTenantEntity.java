...
public class SysTenantEntity {
     ...
     * 转换为领域对象
     */
    public com.clinflash.baseai.domain.user.model.Tenant toDomain() {
        return new com.clinflash.baseai.domain.user.model.Tenant(
                this.id,
                this.orgName,
                this.planCode,
                this.expireAt,
     ...
     * 从领域对象创建JPA实体
     */
    public static SysTenantEntity fromDomain(com.clinflash.baseai.domain.user.model.Tenant domain) {
     ...
     * 更新实体字段
     */
    public void updateFromDomain(com.clinflash.baseai.domain.user.model.Tenant domain) {
