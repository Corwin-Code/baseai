...
public class SysUserRoleEntity {
     ...
     * 转换为领域对象
     */
    public com.clinflash.baseai.domain.user.model.UserRole toDomain() {
        return new com.clinflash.baseai.domain.user.model.UserRole(
                this.userId,
                this.roleId,
                this.createdAt
        );
     ...
     * 从领域对象创建JPA实体
     */
    public static SysUserRoleEntity fromDomain(com.clinflash.baseai.domain.user.model.UserRole domain) {
