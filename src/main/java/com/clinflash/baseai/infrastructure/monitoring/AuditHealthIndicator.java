...
import com.clinflash.baseai.infrastructure.config.AuditConfig;
...
public class AuditHealthIndicator implements HealthIndicator {
     ...
     */
    public AuditHealthIndicator(SysAuditLogRepository auditLogRepository, AuditConfig auditConfig) {
