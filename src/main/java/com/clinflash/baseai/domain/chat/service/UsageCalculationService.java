package com.clinflash.baseai.domain.chat.service;

import com.clinflash.baseai.application.chat.dto.UsageStatisticsDTO;
...
public class UsageCalculationService {
    ...
    public UsageCalculationService(ChatUsageRepository usageRepo, ChatConfig config) {
